...
const calculators: {
  ...
  },
  {
    ...
    icon: Coins,
    iconAnimationClass: "animate-icon-grow",
    available: true,
  },
  {
    href: "/calculator/year-end-tax",
    title: "연말정산 환급액 계산기",
    description: "신용카드·연금저축 등 주요 공제로 예상 환급액을 계산합니다.",
    icon: Wallet,
    iconAnimationClass: "animate-icon-wallet-open",
    available: true,
  },
  {
    href: "/calculator/pension",
    title: "국민연금 예상 수령액 계산기",
    description: "평균소득과 가입기간으로 예상 연금 월액을 추정합니다.",
    icon: Landmark,
    iconAnimationClass: "animate-icon-rise",
    available: true,
  },
  {
    href: "/calculator/unemployment",
    title: "실업급여 계산기",
    description: "평균임금과 가입기간으로 예상 구직급여를 계산합니다.",
    icon: LifeBuoy,
    iconAnimationClass: "animate-icon-bob",
    available: true,
  },
  {
    href: "/calculator/rent-conversion",
    title: "전월세 전환 계산기",
    description: "전세보증금과 월세를 법정 전환율 기준으로 환산합니다.",
    icon: ArrowLeftRight,
    iconAnimationClass: "animate-icon-swap",
    available: true,
  },
  {
    href: "/rates",
